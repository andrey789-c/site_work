    ...
    return (
        <div className="map">
            <div className="container">
                <h1>Заказчик</h1>
                <div className="map__window" ref={mapRef}>
                    ...
                    <div className="map__dot" style={{top: `${dot.y}px`, left: `${dot.x}px`}}></div>
                </div>
                <div className="map__form"><Link to='/form'>Оставить заявку</Link></div>
            </div>
        </div>
    );
}
